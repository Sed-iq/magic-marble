            ...
            <div class="py-4 text-gray-500 dark:text-gray-400">
                ...
                <ul class="mt-6">
                    <li class="relative px-6 py-3">
                        ${this.activeBtnName == 'Dashboard' ?
                            `${this.activeBtn('Dashboard', 'fas fa-house', '/player/dashboard')}`
                            :
                            `${this.inactiveBtn('Dashboard', 'fas fa-house', '/player/dashboard')}`
                        }
                    </li>
                </ul>
                <ul>
                ...
                <li class="relative px-6 py-3">
                    ${this.activeBtnName == 'Profile' ?
                        `${this.activeBtn('Profile', 'fas fa-user', '/player/profile')}`
                        :
                        `${this.inactiveBtn('Profile', 'fas fa-user', '/player/profile')}`
                    }
                </li>
                <li class="relative px-6 py-3">
                    ${this.activeBtnName == 'Setting' ?
                        `${this.activeBtn('Setting', 'fas fa-cog', '/player/setting')}`
                        :
                        `${this.inactiveBtn('Setting', 'fas fa-cog', '/player/setting')}`
                    }
                </li>
                <li class="relative px-6 py-3">
                    <button
