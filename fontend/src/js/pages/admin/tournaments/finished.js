/*
    *Admin Finished Tournaments Class*
...
export default class AdminTournamentsFinished {
    constructor() {
        this.urls = ['/admin/tournaments/finished'];
    ...
    async onLoad() {
        ...
        if (user && user.isAdmin) {
            ...
            await this.loadTournaments('finished','tournamentsTable');
        }
        else {
            ChangeUrl('/login');
        }
