/*
    *Admin Upcoming Tournaments Class*
...
export default class AdminTournamentsUpcoming {
    constructor() {
        this.urls = ['/admin/tournaments/upcoming'];
    ...
    async onLoad() {
        ...
        if (user && user.isAdmin) {
            ...
            await this.loadTournaments('upcoming', 'tournamentsTable');
        }
        else {
            ChangeUrl('/login');
        }
                ...
                tournaments.forEach(tournament => {
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3 text-xs">
                            ...
                            '<span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-sm dark:bg-green-700 dark:text-green-100">Upcoming</span>' :
                            '<span class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-sm dark:bg-red-700 dark:text-red-100">Not Started</span>'}
                        </td>
                        <td class="px-4 py-3 text-sm">
                        ...
                        <td class="px-4 py-3 text-sm">
                            <div class="flex items-center space-x-4 text-sm">
                                <button onclick="ChangeUrl('/admin/tournaments/view?tournamentId=${tournament.id}')"
                                ...
                                <button onclick="ChangeUrl('/admin/tournaments/edit?tournamentId=${tournament.id}')"
                                    class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded dark:bg-green-700 dark:text-green-100">
                                    Edit
                                </button>
                                <button onclick="DeleteTournament('${tournament.id}','/admin/tournaments/upcoming')"
