/*
    *Player Joined Tournaments Class*
...
export default class PlayerTournamentsJoined {
    constructor() {
        this.urls = ['/player/tournaments/joined'];
    ...
    async loadTournaments(userId, tableId) {
        const response = await fetch(`${API_URL}/getPlayerTournaments/?userId=${userId}&status=upcoming`, {
            method: 'GET',
            headers: {
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3 text-sm">
                        <div class="flex items-center space-x-4 text-sm">
                            ...
                            <button onclick="LeaveTournament('${tournament.id}','/player/tournaments/joined')"
