...
export default class AdminTournamentsLive {
    constructor() {
        this.urls = ['/admin/tournaments/live'];
    ...
    async onLoad() {
        ...
        if (user && user.isAdmin) {
            ...
            await this.loadTournaments('live', 'tournamentsTable');
        }
        else {
            ChangeUrl('/login');
        }
                ...
                tournaments.forEach(tournament => {
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3 text-sm">
                            <p class="font-semibold">${(tournament.roundPlayersArr.length > 0) ? tournament.roundPlayersArr[tournament.roundPlayersArr.length - 1].length : tournament.maxPlayers}</p>
                        </td>
                        <td class="px-4 py-3 text-sm">
                        ...
                        <td class="px-4 py-3 text-sm">
                            <div class="flex items-center space-x-4 text-sm">
                                ...
                                <button onclick="DeleteTournament('${tournament.id}','/admin/tournaments/live')"
