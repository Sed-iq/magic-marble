        ...
        <main className="h-full overflow-y-auto">
            <div className="px-6 mx-auto grid">
                ...
                <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                    ...
                    <div className="flex items-center p-4 rounded-lg shadow-xs bg-gray-800">
                        <div className="animate-pulse p-3 mr-4 rounded-full text-green-100 bg-green-500">
                    ...
                    <div className="flex items-center p-4 rounded-lg shadow-xs bg-gray-800">
                        <div className="animate-spin p-3 mr-4 rounded-full text-blue-100 bg-blue-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                                <path
