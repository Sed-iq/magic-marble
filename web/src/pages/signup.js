                        ...
                        <div className="flex items-center justify-center px-2 sm:px-24">
                            <form onSubmit={handleSubmit} className="w-full">
                                ...
                                <label className="block text-sm">
                                    ...
                                    <input
                                        className="block w-full mt-1 px-2 py-3 rounded border border-gray-400 text-sm bg-transparent focus:border-white focus:outline-none text-gray-300 focus:shadow-outline-gray form-input"
                                ...
                                <label className="block mt-2 text-sm">
                                    ...
                                    <input
                                        ...
                                        placeholder="" type="text" name='username' value={username} onChange={handleChange} />
                                </label>
                                <label className="block mt-2 text-sm">
                                ...
                                <button type='button' onClick={googleAuth} className="flex justify-center gap-2 w-full px-4 py-2 mt-3 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-[#292524] border outline-white border-transparent rounded-lg shadow-white active:shadow-2xl hover:shadow-2xl">
                                ...
                                <div className="mt-4 flex justify-center gap-2 align-middle text-center">
                                    <p className='my-auto text-sm text-gray-400'>Already have an account?</p>
